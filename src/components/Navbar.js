...
function Navbar() {
    return (
        <nav className="bg-gradient-to-r from-cyan-800 to-cyan-800 text-white shadow-lg">
            <div className="container mx-auto px-4 py-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    {/* Logo/Brand */}
                    <div className="text-2xl font-bold mb-4 md:mb-0">
                        <Link to="/" className="hover:text-gray-200 transition">
                            <img src="Files/Geotech logo + Tagline RGB 300px.webp" alt="CE Geotech Logo" className="header-logo" />
                        </Link>
                    </div>
